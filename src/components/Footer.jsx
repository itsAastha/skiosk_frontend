      ...
      <div class="container p-6 text-neutral-800 dark:text-neutral-700">
        <div class="grid gap-4 lg:grid-cols-2 py-20">
          <div class="mb-6 md:mb-0 px-20">
            ...
            <p class="mb-4">
              Ramaiah Institute of Technology (RIT) (MSRIT), MSR Nagar, MSRIT
              Post Bangalore-560054, Karnataka INDIA{" "}
            </p>
            <p>
              Phone: 0000000000
          ...
          <div class="mb-6 md:mb-0 ">
            <div className="mx-auto max-w-7xl overflow-hidden  lg:px-8">
              ...
              >
                {navigation.main.map((item) => (
                  <div key={item.name} className="pb-6 ">
                    <a
                      href={item.href}
                      className="text-sm leading-6 text-gray-700 hover:underline"
                    >
                      {item.name}
                    </a>
                  </div>
              ...
              <p className="mt-10 text-center text-xs leading-5 text-gray-500">
                &copy; 2023 Skiosk, All rights reserved.
              </p>
            </div>
          </div>
        </div>
